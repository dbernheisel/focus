...
A terminal UI for viewing your assigned Linear and Notion issues, keeping you focused on what to work on next. Built with Zig and [libvaxis](https://github.com/grimlockOS/libvaxis).

## Features

- Multi-workspace support for Linear and Notion
...
```json
{
  ...
  "notion": [
    {
      "api_key": "ntn_YOUR_KEY"
    }
  ]
}
```

You can configure multiple Linear and/or Notion workspaces. The `notion` array is optional.

### 2. Get API keys

**Linear:** Go to **Settings > Account > API > Personal API keys** and create a key.

**Notion:** Create an [internal integration](https://www.notion.so/my-integrations) and share your database with it.
...
| `notion[].api_key` | Notion integration API key                   | Yes      |
